    ...
    for (let x=0; x<5; x++){
          forecast.push(
            <View style={styles.forecastDay} key={x}>
              <Text style={styles.forecastIcon}>{this.state.forecast[x] && (<Icon size={30} name={icon(this.state.forecast[x].icon)} />)}</Text>
              <Text> {this.state.forecast[x] && (<Text style={styles.forecastTemperature}>{Math.round(this.state.forecast[x].temperatureHigh)}</Text>)}</Text>
            </View>
          )
        }
    ...
    return (
      <View style={styles.container}>
        ...
        <View style={styles.currentWeather}>
          ...
          <Text> {this.state.currentIcon && (<Icon style = {styles.forecastIcon} size={70} name={icon(this.state.currentIcon)} />)} </Text>
